...
if (HAL_CAN_Start(&hcan1) != HAL_OK)
{
  ...
  set_speed[0] = set_speed[1] = set_speed[2] = set_speed[3] = 2000.0f; 				// -8000-8000，双向转
  set_current[0] = set_current[1] = set_current[2] = set_current[3] = 2000.0f;		// -8000-8000，双向转
 ...
 // 力矩控制模式
		...
		{
			set_moto_current(&hcan1, 0x201, set_current[0], set_current[1], set_current[2], set_current[3]);
		}
		...
		if (control_mode == SPEED_MODE)
		{
			...
			set_moto_current(&hcan1, 0x201, (s16)(pid_speed[0].pos_out),
